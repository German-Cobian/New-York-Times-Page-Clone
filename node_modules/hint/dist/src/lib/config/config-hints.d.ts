...
export declare const getSeverity: (config: "warning" | "error" | "off" | "information" | Severity | "hint" | "default" | [import("@hint/utils").HintSeverity, any] | HintConfig[]) => Severity | null;
