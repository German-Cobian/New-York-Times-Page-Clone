...
ava_1.default('childNodes', (t) => {
    const doc = src_1.createHTMLDocument('<body>1<div></div>2</body>', 'http://localhost/');
    t.is(doc.childNodes.length, 1);
    t.is(doc.body.childNodes.length, 3);
    t.is(doc.body.childNodes[1].childNodes.length, 0);
});
ava_1.default('contains', (t) => {
    const doc = src_1.createHTMLDocument('<body>1<div></div>2</body>', 'http://localhost/');
...
ava_1.default('nodeName', (t) => {
    const doc = src_1.createHTMLDocument('<!doctype html><!--comment--><body>text<script>test</script><style>test</style></body>', 'http://localhost/');
...
ava_1.default('nodeType', (t) => {
    const doc = src_1.createHTMLDocument('<!doctype html><!--comment--><body>text</body>', 'http://localhost/');
    t.is(doc.nodeType, 9);
...
ava_1.default('parentElement', (t) => {
    const doc = src_1.createHTMLDocument('<div></div>', 'http://localhost/');
...
ava_1.default('parentNode', (t) => {
    const doc = src_1.createHTMLDocument('<body>test</body>', 'http://localhost/');
...
ava_1.default('textContent', (t) => {
    const doc = src_1.createHTMLDocument('<div>1<div>2</div>3</div>', 'http://localhost/');
