...
exports.getAttributeUnsupported = (feature, browsers) => {
    ...
    return cache_1.getCachedValue(key, browsers, () => {
        ...
        let unprefixed = '';
        if (feature.element) {
            [parentData] = helpers_1.getFeatureData(browser_compat_data_1.mdn.html.elements, feature.element);
            [data, prefix, unprefixed] = helpers_1.getFeatureData(parentData, feature.attribute);
        }
        if (!data) {
        ...
        return browsers_1.getUnsupportedBrowsers(data, prefix, browsers, unprefixed, parentData);
    });
};
